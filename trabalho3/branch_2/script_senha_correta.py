...
def main():
    ...
    # Neste arquivo "senha_input_correta.txt" é armazenado a senha a qual é fornecida pelo o usuário 
    # Após, o script, em python, utiliza-o para inserir na comparação com a senha armazenada
    with open("senha_input_correta.txt", "r") as file:
        user_input_password = file.read().strip()

    # Para fins de teste, podemos também ler o arquivo "senha_incorreta.txt"
    # Neste arquivo "senha_input_incorreta.txt" é armazenado a senha a qual é fornecida pelo o usuário 
    # Após, o script, em python, utiliza-o para inserir na comparação com a senha armazenada   
    #    with open("senha_input_incorreta.txt", "rb") as file:
    #    stored_password = file.read().strip()

    # Senha que o usuário solicitou armazenada no arquivo txt "senha_input_correta.txt"
    password = "senha_input_correta.txt"
